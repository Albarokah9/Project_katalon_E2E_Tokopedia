...
WebUI.verifyElementPresent(findTestObject('Search/AssertionTenda/h1_TENDA VILLAGE 13  GLAMPING  TENDA OTOMATIS NATUREHIKE CNH22ZP004 - MATRAS'), 
    5)

WebUI.verifyTextPresent('TENDA VILLAGE 13 / GLAMPING / TENDA OTOMATIS NATUREHIKE CNH22ZP004 - MATRAS', false)
