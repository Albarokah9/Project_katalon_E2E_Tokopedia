...
WebUI.setText(findTestObject('Login/fieldNoHandphone_Email/input_Nomor HP atau Email_email-phone'), '089611515526')

WebUI.click(findTestObject('Login/selanjutnya/button_Selanjutnya'))

WebUI.click(findTestObject('Login/verifikasiWhatsapp/div_WhatsApp ke 6289611515526'))
